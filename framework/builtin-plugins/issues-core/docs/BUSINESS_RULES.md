# Issues Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `issues-core` and its owned resource set.
...
- This plugin currently exports 8 action(s), 8 resource(s), 0 job definition(s), and 0 workflow definition(s).
