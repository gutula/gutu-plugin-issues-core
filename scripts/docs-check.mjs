...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/issues-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-issues-core:");
...
console.log("Documentation check passed for gutu-plugin-issues-core.");
